...
String cityCode = "101280601";  //手动修改天气城市代码，若为空则自动获取
...
void setup()
{
  ...
  else if(buttonStateTime >= 6500) { //动画-太空人
    EEPROM.write(1,3);
    EEPROM.commit();
  }
  else if(buttonStateTime >= 3500) { //动画-龙猫耍杂技
    EEPROM.write(1,2);
    EEPROM.commit();
  }
  else if(buttonStateTime >= 500) { //动画-龙猫转圈
    EEPROM.write(1,1);
    EEPROM.commit();
  }
...
void imgDisplay(){
  ...
  if(Gif_Mode == 1) { //动画-龙猫转圈
    ...
    y = 86;
    switch(imgNum) {
      case 1:TJpgDec.drawJpg(x,y,ziji_01_61x80, sizeof(ziji_01_61x80));break;
      case 2:TJpgDec.drawJpg(x,y,ziji_02_61x80, sizeof(ziji_02_61x80));break;
      case 3:TJpgDec.drawJpg(x,y,ziji_03_61x80, sizeof(ziji_03_61x80));break;
      case 4:TJpgDec.drawJpg(x,y,ziji_04_61x80, sizeof(ziji_04_61x80));break;
      case 5:TJpgDec.drawJpg(x,y,ziji_05_61x80, sizeof(ziji_05_61x80));break;
      case 6:TJpgDec.drawJpg(x,y,ziji_06_61x80, sizeof(ziji_06_61x80));break;
      case 7:TJpgDec.drawJpg(x,y,ziji_07_61x80, sizeof(ziji_07_61x80));break;
      case 8:TJpgDec.drawJpg(x,y,ziji_08_61x80, sizeof(ziji_08_61x80));break;
      case 9:TJpgDec.drawJpg(x,y,ziji_09_61x80, sizeof(ziji_09_61x80));break;
      case 10:TJpgDec.drawJpg(x,y,ziji_10_61x80, sizeof(ziji_10_61x80));break;
      case 11:TJpgDec.drawJpg(x,y,ziji_11_61x80, sizeof(ziji_11_61x80));break;
      case 12:TJpgDec.drawJpg(x,y,ziji_12_61x80, sizeof(ziji_12_61x80));break;
      case 13:TJpgDec.drawJpg(x,y,ziji_13_61x80, sizeof(ziji_13_61x80));break;
      case 14:TJpgDec.drawJpg(x,y,ziji_14_61x80, sizeof(ziji_14_61x80));break;
      case 15:TJpgDec.drawJpg(x,y,ziji_15_61x80, sizeof(ziji_15_61x80));break;
      case 16:TJpgDec.drawJpg(x,y,ziji_16_61x80, sizeof(ziji_16_61x80));break;
      case 17:TJpgDec.drawJpg(x,y,ziji_17_61x80, sizeof(ziji_17_61x80));break;
      case 18:TJpgDec.drawJpg(x,y,ziji_18_61x80, sizeof(ziji_18_61x80));break;
      case 19:TJpgDec.drawJpg(x,y,ziji_19_61x80, sizeof(ziji_19_61x80));break;
      case 20:TJpgDec.drawJpg(x,y,ziji_20_61x80, sizeof(ziji_20_61x80));break;
      case 21:TJpgDec.drawJpg(x,y,ziji_21_61x80, sizeof(ziji_21_61x80));break;
      case 22:TJpgDec.drawJpg(x,y,ziji_22_61x80, sizeof(ziji_22_61x80));break;
      case 23:TJpgDec.drawJpg(x,y,ziji_23_61x80, sizeof(ziji_23_61x80));break;
      case 24:TJpgDec.drawJpg(x,y,ziji_24_61x80, sizeof(ziji_24_61x80));break;
      case 25:TJpgDec.drawJpg(x,y,ziji_25_61x80, sizeof(ziji_25_61x80));break;
      case 26:TJpgDec.drawJpg(x,y,ziji_26_61x80, sizeof(ziji_26_61x80));break;
      case 27:TJpgDec.drawJpg(x,y,ziji_27_61x80, sizeof(ziji_27_61x80));break;
      case 28:TJpgDec.drawJpg(x,y,ziji_28_61x80, sizeof(ziji_28_61x80));break;
      case 29:TJpgDec.drawJpg(x,y,ziji_29_61x80, sizeof(ziji_29_61x80));break;
      case 30:TJpgDec.drawJpg(x,y,ziji_30_61x80, sizeof(ziji_30_61x80));break;
      case 31:TJpgDec.drawJpg(x,y,ziji_31_61x80, sizeof(ziji_31_61x80));break;
      case 32:TJpgDec.drawJpg(x,y,ziji_32_61x80, sizeof(ziji_32_61x80));break;
      case 33:TJpgDec.drawJpg(x,y,ziji_33_61x80, sizeof(ziji_33_61x80));break;
      case 34:TJpgDec.drawJpg(x,y,ziji_34_61x80, sizeof(ziji_34_61x80));break;
      case 35:TJpgDec.drawJpg(x,y,ziji_35_61x80, sizeof(ziji_35_61x80));break;
      case 36:TJpgDec.drawJpg(x,y,ziji_36_61x80, sizeof(ziji_36_61x80));imgNum = 0;break;
      //case 37:TJpgDec.drawJpg(x,y,ziji_37_61x80, sizeof(ziji_37_61x80));imgNum = 0;break; 
    }
  }
  else if(Gif_Mode == 4) { //动画-龙猫睡觉
    y = 85;
    switch(imgNum) {

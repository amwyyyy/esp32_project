...
//自己的图标
#define MY_ICON_FONT1           "\xEE\x98\x89"   //浮沉
#define MY_ICON_FONT2           "\xEE\x98\x84"   //雷阵雨伴有冰雹
#define MY_ICON_FONT3           "\xEE\x98\x8E"   //扬沙
#define MY_ICON_FONT4           "\xEE\x99\xAC"   //晴
#define MY_ICON_FONT5           "\xEE\x98\xB2"   //强沙尘暴
#define MY_ICON_FONT6           "\xEE\x98\x93"   //热
#define MY_ICON_FONT7           "\xEE\x9C\xBA"   //热带风暴
#define MY_ICON_FONT8           "\xEE\x9B\xA4"   //小雪
#define MY_ICON_FONT9           "\xEE\x98\x83"   //冻雨
#define MY_ICON_FONT10          "\xEE\x98\x90"   //霾
#define MY_ICON_FONT11          "\xEE\x98\x87"   //白天大部多云
#define MY_ICON_FONT12          "\xEE\x98\x8B"   //夜晚大部多云
#define MY_ICON_FONT13          "\xEE\xA6\x81"   //晴间多云
#define MY_ICON_FONT14          "\xEE\xA6\x86"   //飓风
#define MY_ICON_FONT15          "\xEE\x98\x8A"   //大雪
#define MY_ICON_FONT16          "\xEE\x98\x92"   //雨夹雪
#define MY_ICON_FONT17          "\xEE\x98\x80"   //晴间多云
#define MY_ICON_FONT18          "\xEE\x9A\x80"   //大风
#define MY_ICON_FONT19          "\xEE\x98\xA8"   //晴间多云
#define MY_ICON_FONT20          "\xEE\x98\xAA"   //特大暴雨
#define MY_ICON_FONT21          "\xEE\x98\xA4"   //暴雪
#define MY_ICON_FONT22          "\xEE\x9C\x89"   //雷阵雨
#define MY_ICON_FONT23          "\xEE\x98\x86"   //阴
#define MY_ICON_FONT24          "\xEE\x98\x85"   //大雨
#define MY_ICON_FONT25          "\xEE\x98\x88"   //中雨
#define MY_ICON_FONT26          "\xEE\x98\x8C"   //未知
#define MY_ICON_FONT27          "\xEE\x9A\xB6"   //龙卷风
#define MY_ICON_FONT28          "\xEE\x99\xBD"   //暴雨
#define MY_ICON_FONT29          "\xEE\x9A\x84"   //雾
//#define MY_ICON_FONT30          "\xEE\x9A\x88"   //阵雪
#define MY_ICON_FONT31          "\xEE\x98\xBC"   //晴白天
#define MY_ICON_FONT32          "\xEE\x98\xA1"   //冷
#define MY_ICON_FONT33          "\xEE\x9C\xB0"   //大暴雨
#define MY_ICON_FONT34          "\xEE\x98\x81"   //多云
#define MY_ICON_FONT35          "\xEE\x99\xA8"   //沙尘暴
#define MY_ICON_FONT36          "\xEE\x98\xBE"   //小雨
#define MY_ICON_FONT37          "\xEE\x99\x84"   //中雪
#define MY_ICON_FONT38          "\xEE\x9A\xBA"   //阵雨
#define MY_ICON_FONT39          "\xEE\x98\x8D"   //风
#define MY_ICON_FONT40          "\xEE\x98\xA6"   //中雨
